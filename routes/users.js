...
/* 寄出重設密碼信件 */
router.post("/updatePassword", isAuth, (req, res, next) => userController.updatePassword(req, res, next));

/* 重設密碼 */
router.post("/resetPassword", isAuth, (req, res, next) => userController.resetPassword(req, res, next));
